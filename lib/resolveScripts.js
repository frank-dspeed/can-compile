...
function fixPaths(canVersion) {
  ...
  defaultPaths.ejs = defaultPaths.can.replace('canjs.com', canVersion+'.canjs.com');
  defaultPaths.mustache = defaultPaths.can.replace('canjs.com', canVersion+'.canjs.com');
  defaultPaths.stache = defaultPaths.can.replace('canjs.com', canVersion+'.canjs.com');
}
